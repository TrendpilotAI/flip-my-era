...
export function createSupabaseClientWithClerkToken(sessionToken: string | null): SupabaseClient<Database> {
  ...
  clerkSupabaseInstance = createClient<Database>(supabaseUrl || '', supabaseAnonKey || '', {
    auth: {

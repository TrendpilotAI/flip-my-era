    ...
    <div className="relative min-h-screen bg-gradient-to-br from-purple-50/80 via-pink-50/80 to-blue-50/80 dark:from-gray-900/90 dark:via-purple-950/90 dark:to-gray-900/90">
      ...
      <div className="relative z-10">
        ...
        <div className="relative overflow-hidden">
          <div className="absolute inset-0 bg-gradient-to-b from-transparent to-white/30 dark:to-gray-900/30 pointer-events-none" />
        ...
        {!isAuthenticated && (
          <div className="max-w-4xl mx-auto px-4 mb-12">
            <Card className="bg-white/85 backdrop-blur-xl border border-purple-100/50 dark:border-purple-900/50 shadow-2xl">

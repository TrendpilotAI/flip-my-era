...
export const StoryResult = ({ 
  ...
  const { setLatestGeneratedStory } = useStoryWizard();
    ...
    <div className="glass-card rounded-2xl p-8 animate-fadeIn [animation-delay:400ms] bg-white/90 backdrop-blur-lg border border-[#E5DEFF]/50 shadow-xl">
      ...
      <div className="flex flex-wrap gap-4 items-center justify-between mb-8 pt-4 border-t border-[#E5DEFF]">
        <div className="flex gap-2">
          ...
          <Button
            onClick={() => {
              setLatestGeneratedStory(result);
              setShowDownloadShareModal(true);
            }}
            className="text-lg bg-gradient-to-r from-purple-500 via-pink-500 to-orange-400 text-white px-8 py-4 rounded-lg font-bold hover:opacity-90 transition-opacity flex items-center gap-2"
          >

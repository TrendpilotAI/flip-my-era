              ...
              <CardContent>
                ...
                <div className="mt-4 grid grid-cols-2 gap-4 text-sm">
                  <div className="text-center p-3 bg-blue-50 dark:bg-blue-950 rounded-lg">
                    <div className="font-semibold text-blue-700 dark:text-blue-300">{totalChapters}</div>
                    <div className="text-blue-600 dark:text-blue-400">Chapters</div>
                  </div>
                  <div className="text-center p-3 bg-green-50 dark:bg-green-950 rounded-lg">
                    <div className="font-semibold text-green-700 dark:text-green-300">{formatWordCount(totalWords)}</div>
                    <div className="text-green-600 dark:text-green-400">Total Words</div>
                  </div>
                </div>
              </CardContent>
            </Card>

...
const UPSELL_PLANS: UpsellPlan[] = [
  {
    ...
    tagline: STRIPE_PRODUCTS.subscriptions.speakNow.description || 'Find your voice',
    price: STRIPE_PRODUCTS.subscriptions.speakNow.price,
    credits: STRIPE_PRODUCTS.subscriptions.speakNow.credits,
    icon: <Star className="h-6 w-6 text-purple-500" />,
    highlights: STRIPE_PRODUCTS.subscriptions.speakNow.features || [],
  ...
  },
  {
    ...
    tagline: STRIPE_PRODUCTS.subscriptions.midnights.description || "You're the main character",
    price: STRIPE_PRODUCTS.subscriptions.midnights.price,
    credits: STRIPE_PRODUCTS.subscriptions.midnights.credits,
    icon: <Sparkles className="h-6 w-6 text-indigo-500" />,
    highlights: STRIPE_PRODUCTS.subscriptions.midnights.features || [],
  ...
  },
  {
    ...
    tagline: STRIPE_PRODUCTS.subscriptions.erasTour.description || 'Our highest monthly credit allowance',
    price: STRIPE_PRODUCTS.subscriptions.erasTour.price,
    credits: STRIPE_PRODUCTS.subscriptions.erasTour.credits,
    icon: <Crown className="h-6 w-6 text-amber-500" />,
    highlights: STRIPE_PRODUCTS.subscriptions.erasTour.features || [],

-- Migration: Clean Recreate All Tables with TEXT User IDs
-- Date: 2025-07-06
-- This migration completely recreates all tables with proper TEXT-based user IDs
-- to avoid any UUID/TEXT conversion issues

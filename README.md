...
- **Auth**: BetterAuth with Google OAuth and HttpOnly cookie sessions
...
# Server-side secrets (Netlify/Supabase environments; never VITE_ prefixed)
...
- `DATABASE_URL`: PostgreSQL connection string used by BetterAuth
- `BETTER_AUTH_SECRET`: BetterAuth signing secret
- `BETTER_AUTH_URL`: Public app base URL used by BetterAuth callbacks
- `GOOGLE_CLIENT_ID` / `GOOGLE_CLIENT_SECRET`: Google OAuth credentials
- `VITE_SUPABASE_URL`: Your Supabase project URL
- `VITE_SUPABASE_PUBLISHABLE_KEY`: Your Supabase public client key
...
### Test Artifacts
- `test-results.xml` is generated by `bun run test:ci`; do not hand-edit it.
